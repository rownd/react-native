...
const GlobalContextProvider: FunctionComponent<ContextProps> = ({ children, config }) => {
            ...
            case ActionType.LOGIN_SUCCESS:
                ...
                newState = {
                    ...
                    auth: {
                        ...
                        is_verified_user: decodedToken?.['https://auth.rownd.io/is_verified_user'] !== false, // default is `true` if the attribute doesn't exist
                    },
                    user: {
                        ...state.user,
                        data: {
    ...
    const [state, dispatch] = useReducer(mainReducer, initialState, handleStateInit);
